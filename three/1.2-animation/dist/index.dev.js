...
var geometry3 = new THREE.BoxGeometry(300, 100, 100); //材质对象Material
...
var point = new THREE.PointLight(0xffffff); // point.position.set(400, -200, 400); //点光源位置
...
function renderByBalance() {
  ...
  mesh2.rotateY(0.01 * t);
  mesh3.rotateY(0.01 * t);
}
